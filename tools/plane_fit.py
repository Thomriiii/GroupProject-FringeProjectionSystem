...
This is meant to catch common calibration/undistortion/resolution bugs where the point cloud
collapses into a streak/fan instead of a coherent surface.

Usage
-----
  # Fit plane from an existing reconstruction
  python3 tools/plane_fit.py --points scans/<scan>/points_filtered.npz

  # Or reconstruct first, then fit (requires scan dir + calibration files)
  python3 tools/plane_fit.py --scan-dir scans/<scan> --proj-w 1920 --proj-h 1080
"""
