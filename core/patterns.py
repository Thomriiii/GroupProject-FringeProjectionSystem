...
This module creates sinusoidal phase-shifting patterns for both vertical
and horizontal fringes with optional gamma compensation and brightness scaling.
"""
...
def generate_psp_patterns(
    ...
    # Coordinate axis depends on orientation.
    ...
    for f in freqs:
        ...
        for delta in deltas:
            ...
            stripe = 0.5 + 0.5 * CONTRAST_SCALE * np.sin(phase)  # Range [0..1].
...
def generate_midgrey_surface(
    ...
    # Apply the same brightness scaling as the fringe patterns.
