...
Changes vs previous version:
  - Gamma threshold TH1 lowered to 0.12 (more tolerant for dim facets).
  - Modulation threshold TH2 fixed at 12.0 (pixel intensity units).
...
# Global thresholds (good for general use)
